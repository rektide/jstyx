package uk.ac.rdg.resc.jstyx.client.browser2;
/*
...
/**
 * StyxFileSystemModel is a TreeTableModel representing a Styx file
 * system.<p>
 ...
 * happen. StyxFileSystemModel does not enforce any policy in this manner,
 * and it is up to the user of StyxFileSystemModel to ensure it doesn't
 * happen.
 */
...
public class StyxFileSystemModel extends AbstractTreeTableModel
{
    ...
    */
    public StyxFileSystemModel(CStyxFile rootFile)
    {
      super(null);
      isValid = true;
    ...
    */
    class FileNode
    {
      ...
      protected FileNode(CStyxFile file)
      {
          this(null, file);
      }

      protected FileNode(FileNode parent, CStyxFile file)
      {
          this.parent = parent;
          this.file = file;
      ...
      JPopupMenu getPopupMenu()
      {
          ...
          JMenuItem refreshItem = menu.add(new JMenuItem("Refresh"));
          return menu;
      }
      ...
      protected FileNode[] createChildren(MergeSort sorter)
      {
          ...
          try
          {
              CStyxFile[] files = file.getChildren();
              if(files != null)
              {
                  if (sorter != null)
                  {
                  ...
                  {
                      retArray[i] = new FileNode(this, files[i]);
                  }
              }
          }
      ...
      protected boolean loadedChildren()
      {
          try
          {
              return (!file.isDirectory() || (children != null));
          }
          catch(StyxException se)
          {
              se.printStackTrace();
      ...
      protected void setChildren(FileNode[] newChildren, boolean generateEvent)
      {
          ...
          if (generateEvent)
          {
              ...
              fireTreeStructureChanged(StyxFileSystemModel.this, path, null,
              null);
      ...
      protected void nodeChanged()
      {
          ...
          if (parent != null)
          {
              ...
              fireTreeNodesChanged(StyxFileSystemModel.this, path, index, children);
          }
      }
    }
          ...
          if (isValid)
          {
              SwingUtilities.invokeLater(new Runnable()
              {
                  public void run()
                  {
                      ...
                      synchronized(StyxFileSystemModel.this)
                      {
                          reloadCount--;
                          StyxFileSystemModel.this.notifyAll();
                      }
                  }
              });
          }
