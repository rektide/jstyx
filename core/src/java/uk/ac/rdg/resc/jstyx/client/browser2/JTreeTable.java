...
public class JTreeTable extends JTable {
    ...
    private MouseListener ml = new MouseAdapter()
    {
        public void mousePressed(MouseEvent e)
        {
            ...
            if (selRow != -1)
            {
                // TODO: should we check for double clicks in mousePressed,
                // mouseReleased or mouseClicked?
        ...
        private void maybeShowPopup(MouseEvent e)
        {
            ...
            {
                TreePath selPath = tree.getPathForLocation(e.getX(), e.getY());
                System.out.println("Popup on " + selPath);
                // If we don't click on something in the tree itself, selPath
                // will be null
                if (selPath != null)
                {
                    // Get the CStyxFile that we have clicked on
                    Object obj = selPath.getLastPathComponent();
                    if (obj instanceof StyxFileSystemModel.FileNode)
                    {
                        StyxFileSystemModel.FileNode node = 
                            (StyxFileSystemModel.FileNode)obj;
