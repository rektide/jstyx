 ...
 */
class JonTrustManagerFactory extends TrustManagerFactorySpi
{
    ...
    static final X509TrustManager X509 = new X509TrustManager()
    {
        ...
        {
            System.err.println("Checking client trusted: " + x509Certificates.length
                + " certificates, authType = " + authType);
        }

        public void checkServerTrusted( X509Certificate[] x509Certificates,
                                       String authType ) throws CertificateException
        {
            System.err.println("Checking server trusted: " + x509Certificates.length
                + " certificates, authType = " + authType);
        }
