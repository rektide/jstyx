...
\bibitem{wspeer}
Harrison, A., Taylor, I.:
\newblock {WSPeer - An Interface to Web Service Hosting and Invocation}.
...
{OASIS}:
\newblock {WS-BaseNotification} (2004) {\tt
  http://docs.oasis-open.org/wsn/2004/06/\\wsn-WS-BaseNotification-1.2-draft-0%
3.pdf}.

\bibitem{wsrf-lifetime}
{OASIS}:
\newblock {WS-ResourceLifetime} (2005) {\tt http://docs.oasis-open.org/wsrf/\
